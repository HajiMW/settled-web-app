...
/**
 * Login page with email/password form and social sign-in.
 */
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Mock login - in production would use useAuth hook
    setTimeout(() => {
      setLoading(false);
    ...
    <div>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-white dark:bg-deep-navy/80 text-gray-500">or</span>
        </div>
      </div>
